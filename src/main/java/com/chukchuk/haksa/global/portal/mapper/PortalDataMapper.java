package com.chukchuk.haksa.global.portal.mapper;

import com.chukchuk.haksa.domain.student.model.embeddable.AcademicInfo;
import com.chukchuk.haksa.global.portal.dto.raw.*;
import com.chukchuk.haksa.global.portal.model.*;
...
public class PortalDataMapper {
    ...
    public static PortalCurriculumData toPortalCurriculumInfo(List<RawPortalSemesterDTO> semesters) {
        ...
        for (RawPortalSemesterDTO sem : semesters) {
            ...
            for (RawPortalCourseDTO c : sem.courses()) {
                courses.add(new CourseInfo(c.subjtCd(), c.subjtNm(), null, null, c.point(), null, false, null, null, null, null, null));
