...
class PortalLoginServiceUnitTests {
  ...
  @Mock private PortalLoginVerifier portalLoginVerifier;
  ...
  void login_doesNotIssueVerificationTokenWhenPortalLoginFails() {
    ...
    PortalLinkDto.LoginRequest request =
        new PortalLinkDto.LoginRequest("suwon", "17019013", "wrong");
    doThrow(new CommonException(ErrorCode.PORTAL_LOGIN_FAILED))
        .when(portalLoginVerifier)
        .verify("suwon", "17019013", "wrong");
