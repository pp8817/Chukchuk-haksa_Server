...
class PortalConnectionGuardTests {
  ...
  @Mock private UserPortalConnectionRepository userPortalConnectionRepository;
  ...
  void initializeReturnsFailureWhenPortalDataIsMissing() {
    ...
    InitializePortalConnectionService service =
        new InitializePortalConnectionService(
  ...
  void refreshReturnsFailureWhenPortalStudentIsMissing() {
    ...
    PortalConnectionResult result =
        service.executeWithPortalData(userId, new PortalData(null, null, null));
  ...
  void refreshReturnsFailureWhenStudentCodeDiffersFromCurrentStudent() {
    ...
    PortalConnectionResult result =
        service.executeWithPortalData(
            userId,
            new PortalData(
                student("재학", department(), admission(), academic(), "24028036"), null, null));
  ...
  private static PortalStudentInfo student(
      String status, CodeName department, AdmissionInfo admission, PortalAcademicInfo academic) {
