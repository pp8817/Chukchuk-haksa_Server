...
class CourseOfferingServiceUnitTests {
  ...
  @Mock private LiberalArtsAreaCodeRepository liberalArtsAreaCodeRepository;
  ...
  void getOrCreateOffering_whenEnumFieldsMissing_usesSafeDefaults() {
    ...
    when(courseOfferingRepository.saveAll(any()))
  ...
  private CreateOfferingCommand command(
      Long courseId, Long professorId, Long departmentId, Integer areaCode) {
  ...
  private CourseOffering missionExistingMock(
      Long courseId, Long professorId, LiberalArtsAreaCode currentArea) {
    CourseOffering existing = mock(CourseOffering.class);
    Course course = mock(Course.class);
    Professor professor = mock(Professor.class);
